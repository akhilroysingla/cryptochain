...
describe('Blockchain', () => {
    ...
    describe('validTransactionData()', () => {
        ...
        describe('and a block contains multiple identical transactions', () => {
            it('returns false and logs an error', () => {
                // transactionX = wallet.createTransaction({ recipient: 'foo-address', amount: 65 });
                // transactionY = wallet.createTransaction({ recipient: 'foo-address', amount: 65 });
